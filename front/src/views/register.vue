      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="家庭住址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiatingzhuzhi" autocomplete="off" placeholder="家庭住址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.qinshuxingming" class="input" type="text" placeholder="亲属姓名">
			   </div>
			 </div> -->
			<el-form-item label="亲属姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.qinshuxingming" autocomplete="off" placeholder="亲属姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">亲属关系</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qinshuguanxi" class="input" type="text" placeholder="亲属关系">
			   </div>
			 </div> -->
			<el-form-item label="亲属关系" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.qinshuguanxi" autocomplete="off" placeholder="亲属关系"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">紧急电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jinjidianhua" class="input" type="text" placeholder="紧急电话">
			   </div>
			 </div> -->
			<el-form-item label="紧急电话" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jinjidianhua" autocomplete="off" placeholder="紧急电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">疾病史</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jibingshi" class="input" type="text" placeholder="疾病史">
			   </div>
			 </div> -->
			<el-form-item label="疾病史" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jibingshi" autocomplete="off" placeholder="疾病史"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yonghu` == this.tableName && this.ruleForm.jinjidianhua&&(!this.$validate.isMobile(this.ruleForm.jinjidianhua))){
