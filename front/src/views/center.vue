  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="亲属姓名" prop="qinshuxingming">
          <el-input v-model="ruleForm.qinshuxingming"               placeholder="亲属姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="亲属关系" prop="qinshuguanxi">
          <el-input v-model="ruleForm.qinshuguanxi"               placeholder="亲属关系" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="紧急电话" prop="jinjidianhua">
          <el-input v-model="ruleForm.jinjidianhua"               placeholder="紧急电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="疾病史" prop="jibingshi">
          <el-input v-model="ruleForm.jibingshi"               placeholder="疾病史" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yonghu' ==this.flag && this.ruleForm.jinjidianhua&&(!isMobile(this.ruleForm.jinjidianhua))){
