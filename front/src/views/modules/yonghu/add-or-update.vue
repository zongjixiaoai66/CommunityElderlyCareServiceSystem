<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="亲属关系" prop="qinshuguanxi">
          <el-input v-model="ruleForm.qinshuguanxi" 
              placeholder="亲属关系" clearable  :readonly="ro.qinshuguanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="亲属关系" prop="qinshuguanxi">
              <el-input v-model="ruleForm.qinshuguanxi" 
                placeholder="亲属关系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="紧急电话" prop="jinjidianhua">
          <el-input v-model="ruleForm.jinjidianhua" 
              placeholder="紧急电话" clearable  :readonly="ro.jinjidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="紧急电话" prop="jinjidianhua">
              <el-input v-model="ruleForm.jinjidianhua" 
                placeholder="紧急电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疾病史" prop="jibingshi">
          <el-input v-model="ruleForm.jibingshi" 
              placeholder="疾病史" clearable  :readonly="ro.jibingshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="疾病史" prop="jibingshi">
              <el-input v-model="ruleForm.jibingshi" 
                placeholder="疾病史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qinshuxingming = true;
          ...
          if(o=='qinshuguanxi'){
            this.ruleForm.qinshuguanxi = obj[o];
	    this.ro.qinshuguanxi = true;
            continue;
          }
          if(o=='jinjidianhua'){
            this.ruleForm.jinjidianhua = obj[o];
	    this.ro.jinjidianhua = true;
            continue;
          }
          if(o=='jibingshi'){
            this.ruleForm.jibingshi = obj[o];
	    this.ro.jibingshi = true;
            continue;
          }
          if(o=='beizhu'){
