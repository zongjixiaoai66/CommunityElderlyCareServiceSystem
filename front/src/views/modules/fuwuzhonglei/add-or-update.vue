<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务种类" prop="fuwuzhonglei">
          <el-input v-model="ruleForm.fuwuzhonglei" 
              placeholder="服务种类" clearable  :readonly="ro.fuwuzhonglei"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fuwuzhonglei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fuwuzhongleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
